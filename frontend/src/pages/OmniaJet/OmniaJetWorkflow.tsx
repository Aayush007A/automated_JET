          ...
          <div className="fade-slide-in">
            ...
            {activeVisualTab === 'overview' && (
              <div key="overview" className="tab-panel-anim" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {/* ── Unified Hero Header Card with Integrated View Mode Sub-Switcher (Matching Image 3 grouping) ── */}
                <div style={{
                  background: 'linear-gradient(135deg, #FFFFFF 0%, #F8FAFC 70%, #F0FDFA 100%)',
                  borderRadius: '16px',
                  border: '1px solid #E2E8F0',
                  ...
                  {/* Bottom: Integrated Sub-Switcher with Visual Depth and Clear Hierarchy */}
                  <div style={{
                        ...
                        return (
                          <button
                            ...
                            style={{
                              ...
                              borderRadius: '7px',
                              cursor: 'pointer',
                              boxShadow: isSel ? '0 2px 6px rgba(15, 23, 42, 0.08)' : 'none',
                              transition: 'all 0.15s ease',
                            }}
                          >
                            <span style={{
                              ...
                              height: '18px',
                              borderRadius: '50%',
                              background: isSel ? '#007680' : '#CBD5E1',
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      <span style={{
                        ...
                        {overviewSubTab === 'parameter_analytics' ? '12 Analytical Worksheets Active' : 'Funnel & Stratification Mode'}
                      </span>
                    </div>
                  </div>
                </div>
